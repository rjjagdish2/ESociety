...
public class DailyWorkersDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_workers_details);
        ...
        wadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(wname.getEditText().getText().toString().matches(""))) {

                    if (!(wmobile.getEditText().getText().toString().matches("") )){
                    if(!(wprofession.getEditText().getText().toString().matches(""))) {
                        ...
                        dataexp.child("dailyworkers").child(mono).setValue(workerHelper);

                        clr c1=new clr();
                        c1.clear(wname,wmobile,wprofession);
                        wmobile.clearFocus();

                        Toast.makeText(DailyWorkersDetails.this, "Contact Added Successfully", Toast.LENGTH_SHORT).show();
                    }
                    else {
                        Toast.makeText(DailyWorkersDetails.this, "Fill All Details", Toast.LENGTH_SHORT).show();
                    }
                    } else {
                        Toast.makeText(DailyWorkersDetails.this, "Fill All Details", Toast.LENGTH_SHORT).show();
                    }
