...
public class workerList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chkadmin.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(chkad.equals("admin")){
                    Intent intent = new Intent(getApplicationContext(), workerDetails.class);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(workerList.this));
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot workers : snapshot.child(scode).child("workers").getChildren()) {
                ...
                recyclerView.setAdapter(new workerAdapter(workerHelperList, workerList.this));
